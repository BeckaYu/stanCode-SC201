...
File: grader.py
-----------------------------
Milestone 4 answer: the train error vs. validation error under different epochs are:
epochs: 40, train error = 3.6%, validation error = 26.7%
epochs: 70, train error = 1.4%, validation error = 26.1%
epochs: 80, train error = 1.2%, validation error = 26.3%
epochs:90, train error = 0.9%, validation error = 26.5%

We can observe the over-fitting situation in this test,
as the number of epochs increase, train error will decrease since
the prediction fits more precisely to training data; however, this
change increases the prediction error in the validation data.
...
# TODO: The training error reaches 0, validation error is 27.6%
# TODO: If extracts with characters, total numbers of features will increase, thus decreasing the training error but leading to high variance
############################################################
